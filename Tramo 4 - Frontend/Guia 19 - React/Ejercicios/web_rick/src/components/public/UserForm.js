    ...
    <div className="w-25 mx-auto mt-5">
      ...
      <form className="needs-validation" noValidate>
        <div className="row g-3">
          ...
          <div className="col-12">
            <label htmlFor="address" className="form-label">Clave</label>
            <input type="password" className="form-control" id="address" placeholder="Clave" name="password" onChange={handleChanges} required/> {/* con esto se va a ir generando el json que mandamos a la api porq asi lo armamos en el hook */}
          ...
          <button disabled={!areEquals || pass} className="w-100 btn btn-primary btn-lg my-4" type="submit" onClick={handleSubmit}>
            Registrarme
          </button>
        </div>
      </form>
