////	Para armar las matrices tengan en cuenta que los dígitos se leen capa - fila - columna
////	las matrices deben quedarles asi
...
SubProceso llenarMatriz_Z0(calculadora,cadena1)
	...
	Para i<-0 Hasta 2 Con Paso 1 Hacer
		Para j<-0 Hasta 2 Con Paso 1 Hacer
			calculadora(0,i,j) = ConvertirANumero(Subcadena(cadena1,l,l))
			l=l+1
		FinPara
	FinPara
FinSubProceso
...
SubProceso llenarMatriz_Z1(calculadora,cadena2)
	...
	Para i<-0 Hasta 2 Con Paso 1 Hacer
		Para j<-0 Hasta 2 Con Paso 1 Hacer
			calculadora(1,i,j) = ConvertirANumero(Subcadena(cadena2,l,l))
			l=l+1
		FinPara
	FinPara
FinSubProceso
